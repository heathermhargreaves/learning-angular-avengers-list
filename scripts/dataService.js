angular
	.module('avengersApp')
	.service('dataService', function($http) { // A service is a conststructor function!!!
		...
		var authKey = 'apikey=650e6de31b7661db588cb11f982fa8d3';


		this.avengers = function(comicId) {

			return $http.get('http://gateway.marvel.com/v1/public/comics/'+ comicId + '/characters?apikey=650e6de31b7661db588cb11f982fa8d3').then(function(response) {
